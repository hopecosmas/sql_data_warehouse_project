...
Purpose:
This Stored procedure performs the ETL (Extract, Transform, Load) process to the data from the 
bronze layer and then add it to the silver layer.

-- We Truncate Silver table
